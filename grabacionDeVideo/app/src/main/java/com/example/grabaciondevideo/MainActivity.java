package com.example.grabaciondevideo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(this,new String[]{Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO},PETICION_PERMISO_GRABACION);
    ...
    //ES IMPORTANTE TOCAR EL MANIFEST PARA PODER GRABAR
