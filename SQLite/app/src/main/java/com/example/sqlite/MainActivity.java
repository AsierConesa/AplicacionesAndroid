...
public class MainActivity extends AppCompatActivity {
        ...
        if (bbdd != null){
            ...
            if(c1.moveToFirst()){
                do{
                    ...
                    editTextEdad.setText(c1.getString(2));
    ...
    public void consultarTodosRegistro(View view){
        String[] camposMostrar = new String[]{"codigo","nombre","edad","rowid"};
        ...
        if (bbdd != null){
            ...
            if(c1.moveToFirst()){
                do{
                    //Para el recycleview seria metiendolos en el list
        ...
        if (bbdd != null){
            ...
            if(c1.moveToFirst()){
                do{
                    ...
                    editTextEdad.setText(c1.getString(c1.getColumnIndex("edad")));
